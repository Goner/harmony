...
-(CGGradientRef)newGradient
{
    ...
    else if(self.tint == FPPopoverOceanTint)
    {
        if(_arrowDirection == FPPopoverArrowDirectionUp)
        {
            colors[0] = 187.0/255; colors[1] = 201.0/255; colors[2] = 209.0/255;
            colors[4] = 96.0/255; colors[5] = 122.0/255;  colors[6] = 157.0/255;
            colors[3] = colors[7] = 1.0;
...
- (void)drawRect:(CGRect)rect
{
    ...
    {
        CGContextSetRGBFillColor(ctx, 96.0/255, 122.0/255, 157.0/255, 1.0);
    }
